...
pub struct OpenGraph {
    ...
    pub images: Option<Vec<crate::models::OpenGraphImagesInner>>,
    #[serde(rename = "videos", skip_serializing_if = "Option::is_none")]
    pub videos: Option<Vec<crate::models::OpenGraphVideosInner>>,
    #[serde(rename = "audios", skip_serializing_if = "Option::is_none")]
    pub audios: Option<Vec<crate::models::OpenGraphAudiosInner>>,
    #[serde(rename = "article", skip_serializing_if = "Option::is_none")]
    pub article: Option<Box<crate::models::OpenGraphArticle>>,
    #[serde(rename = "book", skip_serializing_if = "Option::is_none")]
    pub book: Option<Box<crate::models::OpenGraphBook>>,
    #[serde(rename = "profile", skip_serializing_if = "Option::is_none")]
    pub profile: Option<Box<crate::models::OpenGraphArticleAuthorsInner>>,
}
