...
pub struct EnvironmentConfig {
    ...
    pub service_settings: Option<Box<crate::models::EnvironmentConfigServiceSettings>>,
    #[serde(rename = "TeamSettings", skip_serializing_if = "Option::is_none")]
    pub team_settings: Option<Box<crate::models::EnvironmentConfigTeamSettings>>,
    #[serde(rename = "SqlSettings", skip_serializing_if = "Option::is_none")]
    pub sql_settings: Option<Box<crate::models::EnvironmentConfigSqlSettings>>,
    #[serde(rename = "LogSettings", skip_serializing_if = "Option::is_none")]
    pub log_settings: Option<Box<crate::models::EnvironmentConfigLogSettings>>,
    #[serde(rename = "PasswordSettings", skip_serializing_if = "Option::is_none")]
    pub password_settings: Option<Box<crate::models::EnvironmentConfigPasswordSettings>>,
    #[serde(rename = "FileSettings", skip_serializing_if = "Option::is_none")]
    pub file_settings: Option<Box<crate::models::EnvironmentConfigFileSettings>>,
    #[serde(rename = "EmailSettings", skip_serializing_if = "Option::is_none")]
    pub email_settings: Option<Box<crate::models::EnvironmentConfigEmailSettings>>,
    #[serde(rename = "RateLimitSettings", skip_serializing_if = "Option::is_none")]
    pub rate_limit_settings: Option<Box<crate::models::EnvironmentConfigRateLimitSettings>>,
    ...
    pub support_settings: Option<Box<crate::models::EnvironmentConfigSupportSettings>>,
    #[serde(rename = "GitLabSettings", skip_serializing_if = "Option::is_none")]
    pub git_lab_settings: Option<Box<crate::models::EnvironmentConfigGitLabSettings>>,
    #[serde(rename = "GoogleSettings", skip_serializing_if = "Option::is_none")]
    pub google_settings: Option<Box<crate::models::EnvironmentConfigGitLabSettings>>,
    #[serde(rename = "Office365Settings", skip_serializing_if = "Option::is_none")]
    pub office365_settings: Option<Box<crate::models::EnvironmentConfigGitLabSettings>>,
    #[serde(rename = "LdapSettings", skip_serializing_if = "Option::is_none")]
    pub ldap_settings: Option<Box<crate::models::EnvironmentConfigLdapSettings>>,
    #[serde(rename = "ComplianceSettings", skip_serializing_if = "Option::is_none")]
    pub compliance_settings: Option<Box<crate::models::EnvironmentConfigComplianceSettings>>,
    #[serde(rename = "LocalizationSettings", skip_serializing_if = "Option::is_none")]
    pub localization_settings: Option<Box<crate::models::EnvironmentConfigLocalizationSettings>>,
    #[serde(rename = "SamlSettings", skip_serializing_if = "Option::is_none")]
    pub saml_settings: Option<Box<crate::models::EnvironmentConfigSamlSettings>>,
    #[serde(rename = "NativeAppSettings", skip_serializing_if = "Option::is_none")]
    pub native_app_settings: Option<Box<crate::models::EnvironmentConfigNativeAppSettings>>,
    #[serde(rename = "ClusterSettings", skip_serializing_if = "Option::is_none")]
    pub cluster_settings: Option<Box<crate::models::EnvironmentConfigClusterSettings>>,
    #[serde(rename = "MetricsSettings", skip_serializing_if = "Option::is_none")]
    pub metrics_settings: Option<Box<crate::models::EnvironmentConfigMetricsSettings>>,
    #[serde(rename = "AnalyticsSettings", skip_serializing_if = "Option::is_none")]
    pub analytics_settings: Option<Box<crate::models::EnvironmentConfigAnalyticsSettings>>,
}
