...
pub async fn create_o_auth_app(configuration: &configuration::Configuration, inline_object96: crate::models::InlineObject96) -> Result<crate::models::OAuthApp, Error<CreateOAuthAppError>> {
...
pub async fn update_o_auth_app(configuration: &configuration::Configuration, app_id: &str, inline_object97: crate::models::InlineObject97) -> Result<crate::models::OAuthApp, Error<UpdateOAuthAppError>> {
    let local_var_configuration = configuration;
