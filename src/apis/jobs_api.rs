...
pub async fn create_job(configuration: &configuration::Configuration, inline_object66: crate::models::InlineObject66) -> Result<crate::models::Job, Error<CreateJobError>> {
    let local_var_configuration = configuration;
