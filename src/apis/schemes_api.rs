...
pub async fn create_scheme(configuration: &configuration::Configuration, create_scheme_request: crate::models::CreateSchemeRequest) -> Result<crate::models::Scheme, Error<CreateSchemeError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&create_scheme_request);
...
pub async fn patch_scheme(configuration: &configuration::Configuration, scheme_id: &str, patch_scheme_request: crate::models::PatchSchemeRequest) -> Result<crate::models::Scheme, Error<PatchSchemeError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&patch_scheme_request);
