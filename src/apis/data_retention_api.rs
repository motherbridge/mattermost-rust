...
pub async fn search_channels_for_retention_policy(configuration: &configuration::Configuration, policy_id: &str, inline_object99: crate::models::InlineObject99) -> Result<Vec<crate::models::ChannelWithTeamData>, Error<SearchChannelsForRetentionPolicyError>> {
    let local_var_configuration = configuration;
...
pub async fn search_teams_for_retention_policy(configuration: &configuration::Configuration, policy_id: &str, inline_object98: crate::models::InlineObject98) -> Result<Vec<crate::models::Team>, Error<SearchTeamsForRetentionPolicyError>> {
    let local_var_configuration = configuration;
