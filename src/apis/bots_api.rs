...
pub async fn create_bot(configuration: &configuration::Configuration, create_bot_request: crate::models::CreateBotRequest) -> Result<crate::models::Bot, Error<CreateBotError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_bot(configuration: &configuration::Configuration, bot_user_id: &str, create_bot_request: crate::models::CreateBotRequest) -> Result<crate::models::Bot, Error<PatchBotError>> {
    let local_var_configuration = configuration;
