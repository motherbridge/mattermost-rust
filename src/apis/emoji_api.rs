...
pub async fn search_emoji(configuration: &configuration::Configuration, search_emoji_request: crate::models::SearchEmojiRequest) -> Result<Vec<crate::models::Emoji>, Error<SearchEmojiError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&search_emoji_request);
